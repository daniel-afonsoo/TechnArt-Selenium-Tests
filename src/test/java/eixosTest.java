...
public class eixosTest {

    @Test
    public void testEixos() {
        ...
        WebElement eixos = driver.findElement(By.xpath("/html/body/div[1]/header/div/nav/div[2]/ul/li[1]/div/a[2]"));
        eixos.click();
        ...
        wait.until(ExpectedConditions.urlContains("axes.php"));
        driver.navigate().refresh();

        WebElement h3 = driver.findElement(By.xpath("//h3"));
       
        assertTrue(h3.getText().contains("AXES"));
        driver.quit();
    }
